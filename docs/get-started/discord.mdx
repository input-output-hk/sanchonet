...
- *#wallets-sanchonet* for wallet discussions, SanchoNet and [CIP-95](https://github.com/cardano-foundation/CIPs/blob/master/CIP-0095/README.md)
- *#govtool-sanchonet* for discussion of [Sancho GovTool beta](https://sanchogov.tools/)
