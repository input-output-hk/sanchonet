...
title: Voting governacne actions
sidebar_position: 6
...
3. Create you vote file using the cardano-cli, in this examplo we will vote `--yes` but you can also vote `--no` or `--abstain` 

Note that --tx-in reffers to the ActionID, 
