...
### Creating goverance actions

Currently,  (Phase1, cardano-node 8.2.0-pre) only stake pools registered on SanchoNet can **create** and **vote** governance actions. In upcomming releases we will incorporate 
