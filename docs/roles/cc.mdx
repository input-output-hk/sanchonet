...
Generate Cold/Hot Keys.
Generate key hashes.
Create a corresponding Cold -> Hot Authorization certificate and submit it on-chain.
Review active governance actions.
Engage in discussions with other CC members to assess the constitutionality of governance actions.
Cast votes.
